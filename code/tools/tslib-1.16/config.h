...
#define LIBTS_VERSION_REVISION 1
...
#define PACKAGE_STRING "tslib 1.16"
...
/* whether one-wire-ts-input should be build as part of libts or as a separate
   shared library which is dlopen()-ed at runtime */
/* #undef TSLIB_STATIC_ONE_WIRE_TS_INPUT_MODULE */
